  ...
  return (
    <div className="w-full p-3">
      {(showDepositModal ||
        ...
        <div
          id="__BVID__241___BV_modal_backdrop_"
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    <div className="col-sm-12 col-md-6">
                      ...
                      >
                        <label className="d-inline-flex items-center text-[14px] leading-[15px]">
                          Show&nbsp;
                          <select
                          ...
                          >
                            {[10, 25, 50, 100, 250, 500, 750, 1000].map(
                              (size) => (
                        ...
                        <tbody role="rowgroup">
                          <tr role="row" className="">
                            ...
                            <td aria-colindex="2" role="cell" className="">
                              <p className="text-right mb-0 cp">200</p>
                            </td>
                            ...
                            <td aria-colindex="8" role="cell" className="">
                              <div role="group" className="btn-group"></div>
                            </td>
                          </tr>
                 ...
                 px-2 py-1 whitespace-nowrap z-10"
                                ...
                                <td aria-colindex="6" role="cell" className="">
                                  <p className="text-left mb-0">0</p>
                                </td>
                                ...
                                <td aria-colindex="8" role="cell" className="">
                                  <div role="group" className="btn-group">
                                    <button
                                      type="button"
                                      className="btn action-button !text-[#eff2f7] hover:!bg-[#636678] !bg-[#444]"
                                      onClick={() => {
                                    ...
                                    <button
                                      ...
                                      className="btn action-button !text-[#eff2f7] hover:!bg-[#636678] !bg-[#444]"
                                      onClick={() => {
                                        setSelectedUserc(item);
                                        setShowCraditModal(true);
                                      }}
                                    >
                                      C
                                    </button>
      ...
      {showDepositModal && (
        <DepositModal
          ...
          updateAccountListDeposit={(userId, newDeposit, newBalance) => {
            setAccountList((prev) =>
              prev.map((user) =>
                user._id === userId
      ...
      {showExposureModal && (
        <ExposureLimitModal
          onClose={handleClose}
          selectedUserl={selectedUserl}
          setSelectedUserl={setSelectedUserl}
      ...
      {showChangeStatusModal && (
        <ChangeStatusModal
          onClose={handleClose}
          selectedUserm={selectedUserm}
          updateAccountList1={(userId, updatedData) => {
            setAccountList((prev) =>
              prev.map((user) =>
                user._id === userId ? { ...user, ...updatedData } : user
              )
