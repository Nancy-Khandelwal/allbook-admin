...
//                 <div
//                     key={key}
//                     className={`market-odd-box ${showOdds < 4 ? ' !w-[58px] lg:!w-[85px]' : '!w-[calc(100%/6)] sm:!w-[58px] lg:!w-[85px]'}  min-h-[40px] min-sm:h-[45px] text-center flex flex-col items-center justify-center ${className} ${key != 2 &&
...
//             <div
//                 key={key}
//                 className={`market-odd-box ${showOdds < 4 ? ' !w-[58px] lg:!w-[85px]' : '!w-[calc(100%/6)] sm:!w-[58px] lg:!w-[85px]'}  min-h-[40px] min-sm:h-[45px] text-center flex flex-col items-center justify-center gap-1 ${className} ${item.changeColor
//                     } ${key != 2 &&
//                     (sportId == "7" || sportId == "4339") &&
//                     "!hidden md:!flex"
//                     }` } 
...
//                     </div></div>
//             </div>
//             <div class={`bet-table-row bet-table-row-top`}><div class={`${showOdds < 4 ? 'text-right nation-name !w-[calc(100%-116px)] lg:!w-[calc(100%-170px)]' : 'text-right nation-name !w-[calc(50%-62px)] sm:!w-[calc(100%-232px)] lg:!w-[calc(100%-340px)]'}`}><span class="max-bet"><span title="Max : 1">1</span></span></div>
//             {showOdds > 4 ? (
//                     <>
...
//                     </>
//                 ) : null}
//              <div class="back bl-title d-none-mobile text-[12px] md:text-[14px] !w-[58px] lg:!w-[85px]">Back</div>
...
//                             <div
//                                 className={`flex flex-col sm:flex-row justify-between items-center ${getRowClass(
//                                     rowSuspended,
//                                     suspendedStatus,
//                                     sportId,
//                                     specialGames
...
//                                     />
//                                 ) : (
//                                     <div className="market-nation-detail w-full sm:w-auto my-1 sm:my-0">
...
const MatchOdds = ({
      ...
      return (
        <div
          ...
          className={`market-odd-box ${
            showOdds < 4
              ? " !w-[58px] lg:!w-[85px]"
              : "!w-[calc(100%/6)] sm:!w-[58px] lg:!w-[85px]"
          }  min-h-[40px] min-sm:h-[45px] text-center flex flex-col items-center justify-center ${className} ${
            key != 2 &&
            (sportId == "7" || sportId == "4339") &&
            "!hidden md:!flex"
          }`}
      ...
      <div
        ...
        className={`market-odd-box ${
          showOdds < 4
            ? " !w-[58px] lg:!w-[85px]"
            : "!w-[calc(100%/6)] sm:!w-[58px] lg:!w-[85px]"
        }  min-h-[40px] min-sm:h-[45px] text-center flex flex-col items-center justify-center gap-1 ${className} ${
          item.changeColor
        } ${
          key != 2 &&
          (sportId == "7" || sportId == "4339") &&
  ...
  return (
    <div className={`game-market p-0 ${marketClass}`}>
      ...
      <div class={`bet-table-row bet-table-row-top`}>
        <div
          class={`${
            showOdds < 4
              ? "text-right nation-name !w-[calc(100%-116px)] lg:!w-[calc(100%-170px)]"
              : "text-right nation-name !w-[calc(50%-62px)] sm:!w-[calc(100%-232px)] lg:!w-[calc(100%-340px)]"
          }`}
        >
          <span class="max-bet">
        ...
        <div class="back bl-title d-none-mobile text-[12px] md:text-[14px] !w-[58px] lg:!w-[85px]">
          Back
        </div>
        <div class="lay bl-title d-none-mobile text-[12px] md:text-[14px] !w-[58px] lg:!w-[85px]">
          Lay
        </div>
        {showOdds > 4 ? (
          <>
